...
return array (
  ...
  array (
    'name' => '登录页',
    'title' => 'ThinkSNS官方社区 - ThinkSNS开源分享系统',
    'keywords' => 'ThinkSNS 开源分享 免费分享 开源SNS',
    'des' => 'ThinkSNS开源分享程序致力于提供中国最好的分享程序、轻知识系统、SNS社交网络平台解决方案，提供分享源代码免费下载。内置分享插件机制和API体系，功能覆盖微群功能、社区群组、论坛分享整合、cms分享整合、长分享、图片分享、等综合功能，使分享二次开发更简单。系统采用php+mysql开发，开源发布，支持多个分享系统同步登陆，是能与ucenter整合的分享系统。智士软件使企业或个人快速拥有分享建站能力，为客户提供高质量的分享软件平台服务。',
    'node' => '',
    'sub' => '保存',
  ),
  'invite' => 
