...
<body>
  ...
  <?php }else{ ?>
   ...
   <form method="POST" action="<?php echo ($savePostUrl); ?>" <?php if(($onsubmit)  !=  ""): ?>onsubmit = "return <?php echo ($onsubmit); ?>;"<?php endif; ?> id='detail_form' name='detail_form'>
    ...
    <?php endif; /*非隐藏域*/ ?>  
      	<?php if($keyType == 'text'): ?>
      	<input name="<?php echo ($pk); ?>" id="form_<?php echo ($pk); ?>" type="text" value="<?php echo (t($defaultS)); ?>" <?php if(($event)  !=  ""): ?>onfocus = "<?php echo ($event); ?>"<?php endif; ?> class="s-txt" style='width:350px'>
      	<?php endif; ?>
        
        <?php if($keyType == 'password'): ?>
      	<input name="<?php echo ($pk); ?>" id="form_<?php echo ($pk); ?>" type="password" value="<?php echo ($defaultS); ?>" <?php if(($event)  !=  ""): ?>onfocus = "<?php echo ($event); ?>"<?php endif; ?>  class="s-txt" style='width:350px'>
      	<?php endif; ?>
        ...
        <?php endif; ?>
      	...
      	<input name="<?php echo ($pk); ?>" type="text" class="text" id="form_<?php echo ($pk); ?>" value='<?php echo ($defaultS); ?>' onfocus="core.rcalendar(this,'full');" readonly style="width:350px;" class="s-txt"/>
      	<?php }endif; ?>
        ...
        <?php endif; ?>
      	...
      	<!-- <FORM style='display:inline;padding:0;margin:0;border:0'>  -->
			...
			<input type="file" name="attach" rel="<?php echo ($upkey); ?>" onchange="admin.upload('<?php echo ($pk); ?>',this)" urlquery='attach_type=feed_image&upload_type=image&thumb=1' style="width:350px;"></div>
           ...
           <input name="<?php echo ($pk); ?>" id="form_<?php echo ($pk); ?>" type="hidden" value="<?php echo ($defaultS); ?>" class="s-txt" style="width:350px;" <?php if(($event)  !=  ""): ?>onchange="<?php echo ($event); ?>"<?php endif; ?>/>
		   <!-- </FORM> -->
    		</div>    
		<?php ++$upkey; ?>
      	<?php endif; ?>
