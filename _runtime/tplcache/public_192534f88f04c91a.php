      ...
      <form id="ajax_login_form" method="POST" action="<?php echo U('public/Passport/doLogin');?>">
        <div class="login-info">
          ...
          <div class="hasno-account">
            <p>还没有帐号？</p>
            <div class="other-but"> <a  onclick="javascript:window.open('<?php echo U('public/Register');?>','_self')" class="white-but fl"><i class="arow-left"></i>去注册</a> <a href="<?php echo U('public/Index/index');?>" class="white-but fr">先看看<i class="arow-right"></i></a> </div>
          </div>
