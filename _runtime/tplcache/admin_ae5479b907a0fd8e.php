...
<div id="container" class="so_main">
  <!-- START TAB框 -->
  <?php if(!empty($pageTab) || C('DEVELOP_MODE')==true): ?>
  <div class="tit_tab">
    <ul>
  ...
  <?php if(!empty($pageButton) || !empty($listData['html'])): ?>
   <!-- START TOOLBAR -->
  <div class="Toolbar_inbox">
    <div class="page right">
    共&nbsp;&nbsp;<?php echo ($listData["totalRows"]); ?>&nbsp;&nbsp;条记录&nbsp;&nbsp;<?php echo ($listData["html"]); ?>
    </div>  
