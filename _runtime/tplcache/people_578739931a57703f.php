...
<div id="page-wrap">
  <div id="main-wrap">
    <div class="find-type">
      <div class="app-title clearfix mb20 border-b">
        <h4 class="left">找伙伴</h4>
        <div class="app-tab-menu clearfix">
          <ul>
            <?php if(in_array('tag',$findPeopleConfig)){ ?>
            <li> <a 
          
              <?php if(($type)  ==  "tag"): ?>class="current"<?php endif; ?>
              href="<?php echo U('people/Index/index', array('type'=>'tag'));?>"><i class="ico-tag"></i>按标签</a>
              <?php if(($type)  ==  "tag"): ?><span class="arrow-t"></span><?php endif; ?>
            </li>
            <?php } ?>
            <?php if(in_array('area',$findPeopleConfig)){ ?>
            <li>
              <?php if($findPeopleConfig[0] != 'area'){ ?>
              <?php } ?>
              <a 
          
              <?php if(($type)  ==  "area"): ?>class="current"<?php endif; ?>
              href="<?php echo U('people/Index/index', array('type'=>'area'));?>"><i class="ico-location"></i>按地区</a>
              <?php if(($type)  ==  "area"): ?><span class="arrow-t"></span><?php endif; ?>
            </li>
            <?php } ?>
            <?php if(in_array('verify',$findPeopleConfig)){ ?>
            <li>
              <?php if($findPeopleConfig[0] != 'verify'){ ?>
              <?php } ?>
              <a 
          
              <?php if(($type)  ==  "verify"): ?>class="current"<?php endif; ?>
              href="<?php echo U('people/Index/index', array('type'=>'verify'));?>"><i class="ico-authentication"></i>认证用户</a>
              <?php if(($type)  ==  "verify"): ?><span class="arrow-t"></span><?php endif; ?>
            </li>
            <?php } ?>
            <?php if(in_array('official',$findPeopleConfig)){ ?>
            <li>
              <?php if($findPeopleConfig[0] != 'official'){ ?>
              <?php } ?>
              <a <?php if(($type)  ==  "official"): ?>class="current"<?php endif; ?>
              href="<?php echo U('people/Index/index', array('type'=>'official'));?>"><i class="ico-authority"></i>官方推荐</a>
              <?php if(($type)  ==  "official"): ?><span class="arrow-t"></span><?php endif; ?>
            </li>
            <?php } ?>
          </ul>
        </div>
      </div>
      <div class="clearfix"> <?php echo W('Menu', array('cid'=>$cid,'sex'=>$sex,'area'=>$area,'verify'=>$verify,'type'=>$type, 'pid' => $pid));?> </div>
    </div>
    <div id="col" class="st-bg clearfix">
      <?php if(in_array($type, array('tag','area'))): ?>
        <?php echo W('Filter', array('cid'=>$cid,'sex'=>$sex,'area'=>$area,'verify'=>$verify,'type'=>$type));?>
      <?php endif; ?>
      <?php if(in_array($type, array('verify','official')) && !empty($topUser)): ?>
        <?php echo W('Face', array('uids'=>$topUser,'type'=>$type));?>
      <?php endif; ?>
