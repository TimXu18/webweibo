...
<div id="page-wrap">
  <div id="main-wrap">
    <div class="clearfix"> <?php if($mid==$uid): ?><div class="profile-title"> 
  <!--个人信息-->
  <div class="person-profile">
    <div class="person-info-face"> <a href="<?php echo U('public/Profile/index', array('uid'=>$uid));?>" title="<?php echo ($user_info[$uid]['uname']); ?>"><img src="<?php echo ($user_info[$uid]['avatar_big']); ?>" /></a> </div>
    <div class="profile-info clearfix">
      <dl class="profile-info-t">
        <dt class="name mb10"><a href="<?php echo U('public/Profile/index', array('uid'=>$uid));?>"><?php echo ($user_info[$uid]['uname']); ?></a>
	        <span class="person-icon">
	        <!--<?php if(is_array($userGroupData[$user_info[$uid]['uid']])): ?><?php $i = 0;?><?php $__LIST__ = $userGroupData[$user_info[$uid]['uid']]?><?php if( count($__LIST__)==0 ) : echo "" ; ?><?php else: ?><?php foreach($__LIST__ as $key=>$vo): ?><?php ++$i;?><?php $mod = ($i % 2 )?><img style="width:auto;height:auto;display:inline;cursor:pointer;vertical-align:-2px;" src="<?php echo ($vo['user_group_icon_url']); ?>" title="<?php echo ($vo['user_group_name']); ?>" />&nbsp;<?php endforeach; ?><?php endif; ?><?php else: echo "" ;?><?php endif; ?>-->
	        <a href="<?php echo U('public/Account/scoredetail');?>" target="_blank"><img style="width:48px;height:10px;display:inline;cursor:pointer;vertical-align:0;" src="<?php echo ($userCredit["level"]["src"]); ?>" event-node='ico_level_right' /></a></span>
        </dt>
        <dd class="from">来自：<?php if( $user_info[$uid]['location'] == '' ): ?>都不知道来自哪里的，大概来自火星吧!<?php else: ?><?php echo ($user_info[$uid]['location']); ?><?php endif; ?>
        <?php if($user_info[$uid]['sex'] == 1): ?><i class="ico-male" style="vertical-align: -2px"></i>
          <?php else: ?>
          <i class="ico-female" style="vertical-align: -2px"></i><?php endif; ?>
        </dd>
        <dd class="profile">简介：<?php if( $user_info[$uid]['intro'] == '' ): ?>这家伙很懒，什么都没有留下!<?php else: ?><?php echo (getshort($user_info[$uid]['intro'],100)); ?><?php endif; ?>
        </dd>
        <dd>标签：<?php if(is_array($userTags)): ?><?php $i = 0;?><?php $__LIST__ = $userTags?><?php if( count($__LIST__)==0 ) : echo "无" ; ?><?php else: ?><?php foreach($__LIST__ as $key=>$vo): ?><?php ++$i;?><?php $mod = ($i % 2 )?><span class="interests"><a href="<?php echo U('people/Index/index', array('cid'=>$key));?>"><?php echo ($vo); ?></a></span><?php endforeach; ?><?php endif; ?><?php else: echo "无" ;?><?php endif; ?>
        </dd>
        <?php if(!empty($user_info[$uid]['certInfo'])): ?>
        <dd class="cert_info <?php echo ($user_info[$uid]['certInfo']['icon']); ?> left clearfix">认证：<?php echo ($user_info[$uid]['certInfo']['info']); ?></dd>
        <?php endif; ?>
      </dl>
    </div>
    <div class="personal-control" id="personal-control">
      <a class="personal-data" href="<?php echo U('public/Profile/data');?>"><i class="i-personal-data"></i>个人资料</a>
      <?php if($mid==$uid): ?><a class="personal-set" href="<?php echo U('public/Account/index');?>"><i class="i-set"></i>个人设置</a><?php endif; ?>
    </div>
  </div>
</div>
<!--top-tab-->
<div class="top-tab">
  <ul class="clearfix my-tab" id="medz-tab-box">
  <?php $top_tab = isset($_GET['tab']) ? $_GET['tab']: 'index'; $tagClass[$top_tab] = 'current'; ?>
    <li style="width:16.66%"><a class="<?php echo ($tagClass[index]); ?>" href="<?php echo U('public/Profile/index',array('uid'=>$mid));?>">分享</a></li>
    <?php if($channelIfOpen) { ?>
    <li style="width:16.66%"><a class="<?php echo ($tagClass[channel]); ?>" href="<?php echo U('public/Profile/appList',array('tab'=>'channel','type'=>'channel','uid'=>$mid));?>">频道</a></li>
    <?php } ?>
    <?php if($weibaIfOpen) { ?>
    <li style="width:16.66%"><a class="<?php echo ($tagClass[weiba]); ?>" href="<?php echo U('public/Profile/appList',array('tab'=>'weiba','type'=>'weiba','uid'=>$mid));?>">微吧</a></li>
    <?php } ?>
    <li style="width:16.66%"><a class="<?php echo ($tagClass[collect]); ?>" href="<?php echo U('public/Profile/collection',array('tab'=>'collect'));?>">收藏</a></li>
    <li style="width:16.66%"><a class="<?php echo ($tagClass[following]); ?>" href="<?php echo U('public/Profile/following', array('tab'=>'following','uid'=>$uid));?>">关注</a></li>
    <li style="width:16.66%;"><a class="<?php echo ($tagClass[follow]); ?>" href="<?php echo U('public/Profile/follower', array('tab'=>'follow','uid'=>$uid));?>" style="border-right:none;">粉丝</a></li>
  </ul>
</div>
<script type="text/javascript">
$(function() {
  $('#medz-tab-box').find('li').css('width', $('#medz-tab-box').width() / $('#medz-tab-box').find('li').size());
});
</script>
 <?php else: ?> <div class="profile-title">
  <!--个人信息-->
  <div class="person-profile">
    <div class="person-info-face"> <a href="<?php echo U('public/Profile/index', array('uid'=>$uid));?>" title="<?php echo ($user_info[$uid]['uname']); ?>"><img src="<?php echo ($user_info[$uid]['avatar_big']); ?>" /></a> </div>
    <div class="profile-info clearfix">
    ...
    <?php if($mid): ?><div class="personal-control" id="personal-control">
      <a class="personal-data" href="<?php echo U('public/Profile/data',array('uid'=>$uid));?>"><i class="i-personal-data"></i>个人资料</a>
      <!-- <?php echo W('UnionBtn', array('fid'=>$user_info[$uid]['uid'], 'uname'=>$user_info[$uid]['uname'], 'union_state'=>$union_state[$user_info[$uid]['uid']], 'isrefresh'=>1));?> -->      
      <?php if(CheckPermission('core_normal','send_message')){ ?>
      <?php if(($userPrivacy["message"])  ==  "0"): ?><a onclick="ui.sendmessage(<?php echo ($user_info[$uid]['uid']); ?>, 0)" href="javascript:void(0)" event-node="postMsg" class="send-email"><i class="i-send-email"></i>发私信</a><?php endif; ?>
      <?php } ?>      
      <?php echo W('FollowBtn', array( 'type'=>'space', 'fid'=>$user_info[$uid]['uid'], 'uname'=>$user_info[$uid]['uname'], 'follow_state'=>$follow_state[$user_info[$uid]['uid']], 'isrefresh'=>1));?>
    </div><?php endif; ?>
    </div> 
</div>
<!--top-tab-->
<div class="top-tab">
  <ul class="clearfix other-tab" id="medz-tab-box">
  <?php $sexName = $user_info[$uid]['sex']==2 ? '她' : '他'; $top_tab = isset($_GET['tab']) ? $_GET['tab']: 'index'; $tagClass[$top_tab] = 'current'; ?>
    <li><a class="<?php echo ($tagClass[index]); ?>" href="<?php echo U('public/Profile/index',array('uid'=>$uid));?>"><?php echo ($sexName); ?>的分享</a></li>
    <?php if($channelIfOpen) { ?>
    <li><a class="<?php echo ($tagClass['channel']); ?>" href="<?php echo U('public/Profile/appList',array('tab'=>'channel','type'=>'channel','uid'=>$uid));?>"><?php echo ($sexName); ?>的频道</a></li>
    <?php } ?>
    <?php if($weibaIfOpen) { ?>
    <li><a class="<?php echo ($tagClass[weiba]); ?>" href="<?php echo U('public/Profile/appList',array('tab'=>'weiba','type'=>'weiba','uid'=>$uid));?>"><?php echo ($sexName); ?>的微吧</a></li>
    <?php } ?>
    <li><a class="<?php echo ($tagClass[following]); ?>" href="<?php echo U('public/Profile/following',array('tab'=>'following','uid'=>$uid));?>"><?php echo ($sexName); ?>的关注</a></li>
    <li><a class="<?php echo ($tagClass[follower]); ?>" href="<?php echo U('public/Profile/follower',array('tab'=>'follower','uid'=>$uid));?>"><?php echo ($sexName); ?>的粉丝</a></li>
  </ul>
</div>
<script type="text/javascript">
$(function() {
  ...
  <div class="right-wrap">
    <div class="right-box clearfix"><!--个人资料-->
      <fieldset>
        <legend class="inter-txt"><?php echo $sexName?$sexName.'的':' '; ?>成就</legend>
      </fieldset>
      <?php $profile = $user_info[$uid]; $profile['medals'] = array_slice($profile['medals'], 0, 3); ?>
      <div class="userinfo clearfix mb20">
        <?php foreach($profile['credit_info']['credit'] as $k=>$vo) { ?>
        <span class="left"><?php echo ($vo["alias"]); ?>:<?php echo ($vo["value"]); ?></span>
        <?php } ?>
      </div>
      <ul>
        <?php if(is_array($profile["medals"])): ?><?php $i = 0;?><?php $__LIST__ = $profile["medals"]?><?php if( count($__LIST__)==0 ) : echo "" ; ?><?php else: ?><?php foreach($__LIST__ as $key=>$vo): ?><?php ++$i;?><?php $mod = ($i % 2 )?><li style="padding-right:12px;"><img  src="<?php echo ($vo["src"]); ?>" width="50" height="50"/></li><?php endforeach; ?><?php endif; ?><?php else: echo "" ;?><?php endif; ?>
        <li><a href="<?php echo U('public/Medal/index');?>"><img src="__APP__/image/task/medal-more.png" width="50" height="50" /></a></li>
      </ul>
    </div>
  </div>
  <div class="right-wrap">
...
function get_feed_img(type){
	...
	var url = "<?php echo U('public/Profile/get_feed_img');?>";
	var uid = "<?php echo ($uid); ?>";
	...
	get_feed_img(1);
      ...
      <div id="col5" class="st-index-main">
        <div class="st-bg cc"> 
          <div class="feed-nav clearfix border-b">
            <div class="mod-feed-tab" id="mod-feed-tab">
              <ul class="inner-feed-nav">
                ...
                ><a href="<?php echo U('public/Profile/index',array('type'=>$type,'feed_type'=>'','feed_key'=>$feed_key,'uid'=>$uid));?>">全部</a>
                </li>
                <li 
                <?php if(($feed_type)  ==  "post"): ?>class="current"<?php endif; ?>
                ><a href="<?php echo U('public/Profile/index',array('type'=>$type,'feed_type'=>'post','feed_key'=>$feed_key,'uid'=>$uid));?>">原创</a>
                </li>
                <li 
                <?php if(($feed_type)  ==  "repost"): ?>class="current"<?php endif; ?>
                ><a href="<?php echo U('public/Profile/index',array('type'=>$type,'feed_type'=>'repost','feed_key'=>$feed_key,'uid'=>$uid));?>">转发</a>
                </li>
                <li 
                <?php if(($feed_type)  ==  "postimage"): ?>class="current"<?php endif; ?>
                ><a href="<?php echo U('public/Profile/index',array('type'=>$type,'feed_type'=>'postimage','feed_key'=>$feed_key,'uid'=>$uid));?>">图片</a>
                </li>
                <li 
                <?php if(($feed_type)  ==  "postvideo"): ?>class="current"<?php endif; ?>
                ><a href="<?php echo U('public/Profile/index',array('type'=>$type,'feed_type'=>'postvideo','feed_key'=>$feed_key,'uid'=>$uid));?>">视频</a>
                </li>
              </ul>
              <!-- <span class="right">
          ...
          <?php echo Addons::hook('feed_top_home');?> 
          <!--feed list--> 
          <!-- 查看他人分享  用于伪静态 FeedList中靠$_REQUEST中的uid取得用户信息 没有$_REQUEST取自己 -->
          <?php $_REQUEST['uid'] = $uid; ?>
          <?php echo W('FeedList',array('type'=>'space','feedApp'=>t($_GET['feedApp']),'feed_type'=>$feed_type,'feed_key'=>$feed_key,'loadnew'=>0));?> </div>
      </div>
      <?php }else{ ?>
